...
export const useTimelineStore = create<TimelineStore>((set, get) => {
  ...
  return {
    ...
    addElementsToTrack: (trackId, elementsData) => {
      get().pushHistory();
      ...
      const newElements: TimelineElement[] = elementsData.map((elementData) => {
        return {
          ...elementData,
          id: generateUUID(),
          startTime: elementData.startTime,
    ...
    insertTrackWithElements: (type, index, elementsData) => {
      get().pushHistory();
